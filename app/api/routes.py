...
def create_api_router(
    *,
    ...
    @router.get(
        "/curation/operator/overview",
        response_model=CurationOperatorOverview,
    )
    def get_curation_operator_overview(
        ...
        return curation_ledger_service.operator_overview(format=format)
